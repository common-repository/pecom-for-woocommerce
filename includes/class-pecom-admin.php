...
class PECOM_Admin {
	...
	public function settings_page( $sections ) {
		$sections['pecom'] = esc_html__( 'PECOM', 'pecom-for-woocommerce' );
	...
	public function register_delivering_status() {
		register_post_status(
			'wc-delivering',
			array(
				'label'                     => esc_html__( 'Delivering', 'pecom-for-woocommerce' ),
				'public'                    => true,
	...
	public function add_order_status( $order_statuses ) {
		...
		foreach ( $order_statuses as $key => $status ) {
			...
			if ( 'wc-processing' === $key ) {
				$new_order_statuses['wc-delivering'] = esc_html__( 'Delivering', 'pecom-for-woocommerce' );
			}
		}
